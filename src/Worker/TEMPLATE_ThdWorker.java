...
public class TEMPLATE_ThdWorker extends Thread implements Runnable, ActionListener
{
	...
	public boolean processInterrupt_1_SEC()
	{
		try
		{
			...
			//WORK
			//			
			//driver.sop("ready to process intr 1 sec... " + driver.time.getTime_Current(":", true));
